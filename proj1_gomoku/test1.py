...
result = []
for i in arr:
    if result.__contains__(i["pinyin"]):
        pass
    else:
        result.append(i["pinyin"])


stri = "BK  奥凯      CA  国航     CN  新华     CZ  南航      DR  瑞丽 DZ 东海   EU  成都     FM  上航     FU   福州  G5  华夏 GS  天津   GX  广西北部湾   HO  吉祥   HU  海航       JD 北京首都航空 JR  幸福航空   KN  联合航空   KY  昆明航空     MF  	厦航  MU 东航 NS  河北航空  PN   西部航空   QW  青岛航空   SC  山航   UQ  乌鲁木齐航空 VD  河南航空  Y8   扬子江快运  YI  云南英安航空  ZH  深航   3U 川航 8C  东星航空  8L  祥鹏航空"
